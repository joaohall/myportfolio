          ...
          <div>
            ...
            >
              <motion.path
                ...
                transition={{duration: 1, delay:1, yoyo: Infinity, ease: cubicBezier(0.99,0.01,0.11,0.99)}}
        ...
        <nav className="flex flex-row justify-center items-center mt-5 fixed w-full z-20">
          ...
          transition={{duration: 0.5, delay:1, ease: 'easeInOut'}}
            ...
            <div className="space-x-2">
              ...
              className="p-2 px-4 rounded transition-all duration-300 mix-blend-difference">
                Projetos
              </motion.button>
              <motion.button
              initial={{ opacity:0, translateY:-20 }}
