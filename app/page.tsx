      ...
      <div className="h-full max-w-[1440px] md:justify-end md:items-start items-center justify-center m-auto flex flex-col relative z-10">
        <div className="to-left opacity-0 md:text-left text-center z-10 items-center ">
          ...
          <div className="flex gap-10 md:justify-start justify-center">
            <button className="p-2 px-6 bg-[#2400FF] md:text-white rounded-xl hover:tracking-widest transition-all hover:space-x-9 ">
    ...
    return (
      <div className="z-30">
       <div className="sm:flex hidden justify-center m-auto">
        <nav className="flex flex-row p-12 gap-8 fixed justify-between items-center w-full max-w-[1440px] z-50 ">
          <Image src={icon} width={30} alt="" className="text-open-1 opacity-0" />
          <div className="flex flex-row gap-12 items-center">
            <a href="#" className="hover:text-[#2400FF] transition-all duration-700 opacity-0 text-open-4">Início</a>
            <a href="#" className="hover:text-[#2400FF] transition-all duration-700 opacity-0 text-open-3">Experiência</a>
            <a href="#" className="hover:text-[#2400FF] transition-all duration-700 opacity-0 text-open-2">Blog</a>
            <a href="#" className="hover:text-[#2400FF] transition-all duration-700 opacity-0 text-open-1">Projetos</a>
          </div>
        </nav>
      </div>
      </div>
